...
public class DataHelper {
    ...
    @DisplayName("Сценарий 1. Заявка Оплата по карте, заполненная валидными данными карты со статусом Approved успешно одобрена банком")
    public static Card getApprovedCard() {
        return new Card("4444 4444 4444 4441", getValidMonth(), gerValidYear(), getValidHolder(), getValidCvc());

    }

    @DisplayName("Сценарий 2. Заявка Оплата по карте, заполненная данными карты со статусом Declined отклонена банком")
    ...
    public static Card getHolderHyphenated() {
        return new Card("4444 4444 4444 4441", getValidMonth(), gerValidYear(), "Rimsky-Korsakov Ivan", getValidCvc());
    }
    ...
    @DisplayName("Сценарий 4. Негативный. Отправка формы заявки, в которой поле Номер карты содержит 15 цифр. Остальные поля формы заполнены валидными данными")
    ...
    // Поле месяц
    @DisplayName("Сценарий 5. Негативный. Отправка формы заявки, в которой поле Месяц пустое. Остальные поля формы заполнены валидными данными")
    ...
    @DisplayName("Сценарий 8. Негативный. Отправка формы заявки, в которой поле Месяц содержит значение предыдущее от текущего. Остальные поля формы заполнены валидными данными")
    ...
    //Поле CVC
    @DisplayName("Сценарий 12. Негативный. Отправка формы заявки, в которой поле CVC/CVV пусто. Остальные поля формы заполнены валидными значениями")
    ...
    public static Card getOneNumberCVC() {
        return new Card("4444 4444 4444 4441", getValidMonth(), gerValidYear(), getValidHolder(), "1");
    }
    ...
    public static Card getTwoNumberCVC() {
        return new Card("4444 4444 4444 4441", getValidMonth(), gerValidYear(), getValidHolder(), "22");
    }
    ...
    @DisplayName("Сценарий 16. Негативный. Отправка формы заявки, в которой поле Владелец содержит фамилию на латинице, а имя отсутствует. Остальные поля формы заполнены валидными данными")
    ...
    @DisplayName("Сценарий 17. Негативный. Отправка формы заявки, в которой поле Владелец содержит фамилию и имя на кириллице. Остальные поля формы заполнены валидными данными")
